...
# OpenAI-compatible prompts (base)
...
# OpenAI-compatible prompts (LSP-enabled)
SYSTEM_PROMPT_OPENAI_LSP = SEARCH_SYSTEM_PROMPT_OPENAI_LSP
USER_PROMPT_TEMPLATE_OPENAI_LSP = SEARCH_USER_PROMPT_TEMPLATE_OPENAI_LSP
TURN_HINT_TEMPLATE_OPENAI_LSP = SEARCH_TURN_HINT_TEMPLATE_OPENAI_LSP
TURN_INSTRUCTIONS_OPENAI_LSP = SEARCH_TURN_INSTRUCTIONS_OPENAI_LSP
