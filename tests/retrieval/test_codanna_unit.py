...
from relace_mcp.repo.backends.codanna import (
...
class TestCodannaSearchAutoRetry:
    @patch("relace_mcp.repo.backends.codanna_search._ensure_codanna_index")
    @patch("relace_mcp.repo.backends.codanna_search._run_cli_json")
