...
function pageInfo(pathname: string): { title: string; Icon: typeof BarChart3 } {
  ...
  if (pathname.startsWith('/runs/') || /^\/experiments\/[^/]+\/cases\//.test(pathname)) {
...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-[var(--cds-border-strong-01)] bg-[var(--cds-layer-01)]">
